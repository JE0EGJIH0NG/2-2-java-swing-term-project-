...
public class Zealot extends JFrame implements KeyListener {
	Bonus b = new Bonus();
	boolean up = false;
	boolean down = false;
	boolean left = false;
	...
	int zealot_size_w = 70;
	int zealot_size_h = 70;
	...
	/*
	 * __________________처치 후
	 * 보상______________________________________________________
	 */
...
/*
 * case KeyEvent.VK_RIGHT: x+=1; repaint();
 * System.out.println("zealot의 keypressed"); break; //왼쪽 case KeyEvent.VK_LEFT:
 * x-=1; repaint(); break; case KeyEvent.VK_UP&&KeyEvent.VK_RIGHT: y-=1;
 * repaint(); break;
 */

/*
 * //right if(e.getKeyCode()==KeyEvent.VK_RIGHT &&
 * e.getKeyCode()!=KeyEvent.VK_LEFT && e.getKeyCode()!=KeyEvent.VK_UP &&
 * e.getKeyCode()!=KeyEvent.VK_DOWN) { x+=1;repaint(); } //left else
 * if(e.getKeyCode()!=KeyEvent.VK_RIGHT && e.getKeyCode()==KeyEvent.VK_LEFT &&
 * e.getKeyCode()!=KeyEvent.VK_UP && e.getKeyCode()!=KeyEvent.VK_DOWN) {
 * x-=1;repaint(); } //up else if(e.getKeyCode()!=KeyEvent.VK_RIGHT &&
 * e.getKeyCode()!=KeyEvent.VK_LEFT && e.getKeyCode()==KeyEvent.VK_UP &&
 * e.getKeyCode()!=KeyEvent.VK_DOWN) { y-=1;repaint(); } //down else
 * if(e.getKeyCode()!=KeyEvent.VK_RIGHT && e.getKeyCode()!=KeyEvent.VK_LEFT &&
 * e.getKeyCode()!=KeyEvent.VK_UP && e.getKeyCode()==KeyEvent.VK_DOWN) {
 * y+=1;repaint(); } //right n up else if(e.getKeyCode()==KeyEvent.VK_RIGHT &&
 * e.getKeyCode()!=KeyEvent.VK_LEFT && e.getKeyCode()==KeyEvent.VK_UP &&
 * e.getKeyCode()!=KeyEvent.VK_DOWN) { y-=1;x+=1;repaint(); }
 */

/*
 * public void move(boolean right,boolean left,boolean up,boolean down) {
 * System.out.println("move1"+right); if(right==true && left==false && up==false
 * && down==false) { x+=1; System.out.println("x+=1test"); }
 * 
 * else if(right==true && left==false && up==true && down==false) { x+=1;y-=1;
 * System.out.println("x+=1 n y-= 1 test"); } }
 */
/*
 * if (right==true && left==false && up==false && down==false ) { x+=1;
 * //right=false; } else if (right==false && left==true && up==false &&
 * down==false ) { x-=1; //left=false; } else if (right==false && left==false &&
 * up==true && down==false ) { y-=1; //up=false; } else if (right==false &&
 * left==false && up==false && down==true ) { y+=1; //down=false; } else if
 * (right==true && left==false && up==true && down==false ) { x+=1; y-=1;
 * //right=false; up=false; } else if (right==true && left==false && up==false
 * && down==true ) { x+=1; y+=1; //right=false; down=false; } else if
 * (right==false && left==true && up==true && down==false ) { x-=1; y-=1;
 * //left=false; up=false; } else if (right==false && left==true && up==false &&
 * down==true ) { x-=1; y+=1; //left=false; down=false; }
 */